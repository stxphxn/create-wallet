 ...
 */
export function generateHDWallet(network = 'TEST', addressType = 'P2PKH', mnemonic) {
    var wallet = hdutil.generateHDWallet(network == 'TEST' ? 0 : 1, mnemonic); //wallet not to be confused with Realm Wallet Object
