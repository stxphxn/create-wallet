  ...
  <header>
      ...
      <h2>
        ...
        <div class="class-description">
          <p>Build &amp; Send Transactions out to the network Easily using Addresses!</p>
        </div>
...
<hr />
  ...
  <span class='name-container'>
    <a class="link-icon" href="#TransactionBuilder">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h4 class="name" id="TransactionBuilder">
      <span class="type-signature"></span>new TransactionBuilder<span class="signature">(coin, options<span class="signature-attributes">opt</span>, account<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
    </h4>
  </span>
  ...
  <div class="description">
    <p>Create a new TransactionBuilder</p>
<h5>Example</h5><pre class="prettyprint source"><code>import bip32 from 'bip32'
    ...
    <span class="param-type">
      <a href="global.html#CoinInfo">CoinInfo</a>
        ...
        <td class="description last">
          <p>CoinInfo for this specific Network you want to send the Transaction on.</p>
  ...
  <tbody>
    ...
    <span class="param-type">
      Array.&lt;<a href="Address.html">Address</a>>
        ...
        <td class="description last">
          <p>The Address(es) to send from.</p>
    ...
    <span class="param-type">
      Array.&lt;<a href="global.html#OutputAddress">OutputAddress</a>>
        ...
        <td class="description last">
          <p>The amounts &amp; Address(es) to send to.</p>
    ...
    <span class="param-type">
      string
        ...
        <td class="description last">
          <p>The FloData to be added to the Transaction</p>
    ...
    <span class="param-type">
      <a href="Account.html">Account</a>
        ...
        <td class="description last">
          <p>An Account to get a Change Address from if needed, if undefined, change will be sent to first <code>from</code> Address.</p>
...
<dl class="details">
    ...
    <dd class="tag-source">
      <ul class="dummy">
        <li>
          <a href="TransactionBuilder.js.html">TransactionBuilder.js</a>, <a href="TransactionBuilder.js.html#line60">line 60</a>
        </li>
      </ul>
    </dd>
...
<hr />
  ...
  <span class='name-container'>
    <a class="link-icon" href="#addFrom">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h4 class="name" id="addFrom">
      <span class="type-signature"></span>addFrom<span class="signature">(address)</span><span class="type-signature"></span>
    </h4>
  </span>
  ...
  <div class="description">
    <p>Add an Address to send from</p>
  </div>
  ...
  <tbody>
    ...
    <span class="param-type">
      <a href="Address.html">Address</a>
        ...
        <td class="description last">
          <p>Address to add to the From Addresses</p>
...
<dl class="details">
    ...
    <dd class="tag-source">
      <ul class="dummy">
        <li>
          <a href="TransactionBuilder.js.html">TransactionBuilder.js</a>, <a href="TransactionBuilder.js.html#line111">line 111</a>
        </li>
      </ul>
    </dd>
  ...
  <div class="example-container">
    <a class="link-icon" href="#addFrom-examples">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h5 id="addFrom-examples">Example</h5>
...
var builder = new TransactionBuilder(Networks.flo)
builder.addFrom(address);</code></pre>
...
<hr />
  ...
  <span class='name-container'>
    <a class="link-icon" href="#addTo">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h4 class="name" id="addTo">
      <span class="type-signature"></span>addTo<span class="signature">(address, amount)</span><span class="type-signature"></span>
    </h4>
  </span>
  ...
  <div class="description">
    <p>Add an Address and Amount to send to</p>
  </div>
  ...
  <tbody>
    ...
    <span class="param-type">
      string
        ...
        <td class="description last">
          <p>Base58 Public Address to send To</p>
    ...
    <span class="param-type">
      number
        ...
        <td class="description last">
          <p>Amount to Send (in whole coin)</p>
...
<dl class="details">
    ...
    <dd class="tag-source">
      <ul class="dummy">
        <li>
          <a href="TransactionBuilder.js.html">TransactionBuilder.js</a>, <a href="TransactionBuilder.js.html#line131">line 131</a>
        </li>
      </ul>
    </dd>
  ...
  <div class="example-container">
    <a class="link-icon" href="#addTo-examples">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h5 id="addTo-examples">Example</h5>
...
var builder = new TransactionBuilder(Networks.flo)
builder.addTo("FHQvhgDut1rn1nvQRZ3z9QgMEVMavRo2Tu", 0.001);</code></pre>
...
<hr />
  ...
  <span class='name-container'>
    <a class="link-icon" href="#buildInputsAndOutputs">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h4 class="name" id="buildInputsAndOutputs">
      <span class="type-signature">(async) </span>buildInputsAndOutputs<span class="signature">(manual_utxos<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="global.html#SelectedInputOutput">SelectedInputOutput</a>}</span>
    </h4>
  </span>
  ...
  <div class="description">
    <p>Get calculated Inputs and Outputs (and Fee) for From and To Addresses</p>
  </div>
...
<table class="params">
  ...
  <tbody>
      ...
      <tr>
          ...
          <td class="name"><code>manual_utxos</code></td>
    ...
    <span class="param-type">
      Array.&lt;<a href="global.html#utxo">utxo</a>>
        ...
        <td class="description last">
          <p>Pass in utxos for the function to use. If not passed, it will call the function getUnspents()</p>
...
<dl class="details">
    ...
    <dd class="tag-source">
      <ul class="dummy">
        <li>
          <a href="TransactionBuilder.js.html">TransactionBuilder.js</a>, <a href="TransactionBuilder.js.html#line252">line 252</a>
        </li>
      </ul>
    </dd>
  ...
  <div class="example-container">
    <a class="link-icon" href="#buildInputsAndOutputs-examples">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h5 id="buildInputsAndOutputs-examples">Example</h5>
...
<h5>Returns:</h5>
  ...
  <dl class="param-type">
    ...
    <span class="param-type">
      <a href="global.html#SelectedInputOutput">SelectedInputOutput</a>
    </span>
...
<hr />
  ...
  <span class='name-container'>
    <a class="link-icon" href="#buildTX">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h4 class="name" id="buildTX">
      <span class="type-signature">(async) </span>buildTX<span class="signature">(manual_selected<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;string>}</span>
    </h4>
  </span>
  ...
  <div class="description">
    <p>Build the Transaction hex for the From and To addresses</p>
  </div>
...
<table class="params">
  ...
  <tbody>
      ...
      <tr>
          ...
          <td class="name"><code>manual_selected</code></td>
    ...
    <span class="param-type">
      <a href="global.html#SelectedInputOutput">SelectedInputOutput</a>
        ...
        <td class="description last">
          <p>Inputs and Outputs to use. If not passed, the function buildInputsAndOutputs() is run.</p>
...
<dl class="details">
    ...
    <dd class="tag-source">
      <ul class="dummy">
        <li>
          <a href="TransactionBuilder.js.html">TransactionBuilder.js</a>, <a href="TransactionBuilder.js.html#line356">line 356</a>
        </li>
      </ul>
    </dd>
  ...
  <div class="example-container">
    <a class="link-icon" href="#buildTX-examples">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h5 id="buildTX-examples">Example</h5>
...
<h5>Returns:</h5>
  ...
  <div class="param-desc">
    <p>Returns a Promise that resolves to the calculated Transaction Hex</p>
  </div>
...
<hr />
  ...
  <span class='name-container'>
    <a class="link-icon" href="#discoverChange">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h4 class="name" id="discoverChange">
      <span class="type-signature">(async) </span>discoverChange<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span>
    </h4>
  </span>
  ...
  <div class="description">
    <p>Discover the used change addresses if we were passed an Account to discover from.</p>
  </div>
...
<dl class="details">
    ...
    <dd class="tag-source">
      <ul class="dummy">
        <li>
          <a href="TransactionBuilder.js.html">TransactionBuilder.js</a>, <a href="TransactionBuilder.js.html#line321">line 321</a>
        </li>
      </ul>
    </dd>
  ...
  <div class="example-container">
    <a class="link-icon" href="#discoverChange-examples">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h5 id="discoverChange-examples">Example</h5>
...
<hr />
  ...
  <span class='name-container'>
    <a class="link-icon" href="#getUnspents">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h4 class="name" id="getUnspents">
      <span class="type-signature">(async) </span>getUnspents<span class="signature">()</span><span class="type-signature"> &rarr; {Promise.&lt;Array.&lt;<a href="global.html#utxo">utxo</a>>>}</span>
    </h4>
  </span>
  ...
  <div class="description">
    <p>Get the Unspent Transaction Outputs for all the From addresses specified.</p>
  </div>
...
<dl class="details">
    ...
    <dd class="tag-source">
      <ul class="dummy">
        <li>
          <a href="TransactionBuilder.js.html">TransactionBuilder.js</a>, <a href="TransactionBuilder.js.html#line213">line 213</a>
        </li>
      </ul>
    </dd>
  ...
  <div class="example-container">
    <a class="link-icon" href="#getUnspents-examples">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h5 id="getUnspents-examples">Example</h5>
...
<h5>Returns:</h5>
  ...
  <div class="param-desc">
    <p>Returns a Promise that will resolve to an Array of unspent utxos</p>
  </div>
...
<hr />
  ...
  <span class='name-container'>
    <a class="link-icon" href="#parseOptions">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h4 class="name" id="parseOptions">
      <span class="type-signature"></span>parseOptions<span class="signature">(options)</span><span class="type-signature"></span>
    </h4>
  </span>
...
<dl class="details">
    ...
    <dd class="tag-source">
      <ul class="dummy">
        <li>
          <a href="TransactionBuilder.js.html">TransactionBuilder.js</a>, <a href="TransactionBuilder.js.html#line161">line 161</a>
        </li>
      </ul>
    </dd>
  ...
  <div class="example-container">
    <a class="link-icon" href="#parseOptions-examples">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h5 id="parseOptions-examples">Example</h5>
...
<hr />
  ...
  <span class='name-container'>
    <a class="link-icon" href="#sendTX">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h4 class="name" id="sendTX">
      <span class="type-signature">(async) </span>sendTX<span class="signature">(manual_hex<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;string>}</span>
    </h4>
  </span>
  ...
  <div class="description">
    <p>Build &amp; Send the Transaction that we have been forming</p>
  </div>
...
<table class="params">
  ...
  <tbody>
      ...
      <tr>
          ...
          <td class="name"><code>manual_hex</code></td>
    ...
    <span class="param-type">
      String
        ...
        <td class="description last">
          <p>The hex you wish to send the tx for. If not used, the hex is grabbed from buildTX().</p>
...
<dl class="details">
    ...
    <dd class="tag-source">
      <ul class="dummy">
        <li>
          <a href="TransactionBuilder.js.html">TransactionBuilder.js</a>, <a href="TransactionBuilder.js.html#line468">line 468</a>
        </li>
      </ul>
    </dd>
  ...
  <div class="example-container">
    <a class="link-icon" href="#sendTX-examples">
      <svg height="20" width="20" style="fill: black;">
        <use xlink:href="#linkIcon"></use>
      </svg>
    </a>
    <h5 id="sendTX-examples">Example</h5>
